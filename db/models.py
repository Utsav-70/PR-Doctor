...
Two tables for this slice. Installation and repository metadata is denormalised onto
`reviews` — normalising it costs two joins and buys nothing until there is a UI or
per-repository configuration to hang off it.
"""
